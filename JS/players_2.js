...
var player2 = prompt("Please enter player2 name (yellow) : ");
...
function changePlayer() {
    ...
    switch (text.innerText) {
        case player1: text.innerText = player2; text.style.color = "yellow"; break;
        case player2: text.innerText = player1; text.style.color = "red"; break;
